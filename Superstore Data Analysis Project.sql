...
ALTER TABLE project ADD COLUMN order_date_parsed DATE;
ALTER TABLE project ADD COLUMN ship_date_parsed DATE;
UPDATE project
SET order_date_parsed = STR_TO_DATE(`Order Date`, '%d-%m-%Y'),
    ship_date_parsed = STR_TO_DATE(`Ship Date`, '%d-%m-%Y');
